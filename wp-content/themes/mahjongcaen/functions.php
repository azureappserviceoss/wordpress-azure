...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'after_widget' => '</li>',
		'before_title' => '<h2 class="widget-title"><span class="tt">',
		'after_title' => '</span></h2>',
	) );
...
function wpjam_blogroll(){
    ...
    if($wpjam_blogroll_setting){
        ...
        foreach ($wpjam_blogrolls as $wpjam_blogroll) {
            ...
            echo '<a href="'.trim($wpjam_blogroll[0]).'" target="_blank" title="'.esc_attr(trim($wpjam_blogroll[1])).'">'.trim($wpjam_blogroll[1]).'</a> <span>|</span> ';
        }
    }
}
